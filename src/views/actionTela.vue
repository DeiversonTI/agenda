    ...
    <div class="flex items-center justify-center w-full h-screen ">
        <div class="rounded-md bg-white  w-4/5  lg:mx-auto ">
            ...
            <div class="gap-4 sm:block md:block lg:flex  lg:gap-4 space-y-5 lg:space-y-0 ">
                ...
                <!-- CADASTRAR EVENTOS -->
                <div class="  py-8 px-2 rounded-md text-gray-50 border-2 shadow-xl lg:w-auto xl:w-3/6 2xl:w-3/6 ">
                    <div class=" flex items-center justify-center 2xl:w-full ">
                        ...
                        <div class="ml-2 mr-2">                 
                            ...
                            <button class="text-gray-50 bg-blue-700 py-2 px-12 rounded-xl mt-4 text-lg border-4 hover:border-4 hover:border-blue-300 hover:bg-blue-800"><router-link to="/Auth">Entrar</router-link></button>
                        </div>
                    </div>
               </div>

                <!-- AGENDA ONLINE -->
                <div class="py-8 px-2 rounded-md text-gray-50 border-2 shadow-lg lg:w-auto xl:w-3/6 2xl:w-3/6  ">
                    <div class="flex items-center justify-center 2xl:w-full">
                        <div class="hidden sm:flex md:w-56 sm:w-3/4 lg:w-96 2xl:w-2/6">
