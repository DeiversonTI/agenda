<template>
    <div class="bg-gradient-to-l from-white via-Sky-100 to-white w-screen h-screen flex justify-center items-center  ">
        <div class="lg:px-40 xl:px-56 lg:h-80 md:h-80 sm:h-80 xl:h-80 xl:w-3/4 2xl:h-80  2xl:w-3/5 sm:px-11 w-full mx-4 sm:flex sm:justify-center sm:items-center  ">
            ...
            <div class="md:w-96 bg-gray-50 h-full sm:h-80 sm:rounded-r-lg sm:rounded-bl-none rounded-b-lg ">
                <form  class="bg-white rounded-lg sm:h-80 px-3 pt-2 pb-6 mb-2 w-full  shadow-2xl ">
                    <h2 class="pt-6 text-center text-4xl font-sans text-gray-500 sm:mb-2 2xl:text-xl 2xl:mb-1">Reset Password</h2>
                    <div class="pt-6">
                    ...
                    <div class=" m-auto h-14 justify-between text-gray-900 items-center flex text-center w-full   ">
                        <button class="m-auto w-36 h-8 mt-10 rounded  text-center text-gray-50 bg-Cyan-700" alt="Botão de resetar senha" @click="reset()">Esqueci a Senha</button>
                    </div>
